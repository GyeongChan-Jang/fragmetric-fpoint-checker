          ...
          <TabsContent value='distribution' className='pt-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Where F Points are being earned across assets</CardDescription>
              </CardHeader>
              <CardContent>
                <div className='h-80 w-full'>
                  {stats && (
                    <ChartContainer config={sourceDistConfig} className='h-full'>
          ...
          <TabsContent value='boosts' className='pt-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Percentage of users with different boost types</CardDescription>
              </CardHeader>
              <CardContent>
                <div className='h-80 w-full'>
                  {stats && (
          ...
          <TabsContent value='defi' className='pt-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Where F Points are being earned in DeFi</CardDescription>
              </CardHeader>
              <CardContent>
                <div className='h-80 w-full'>
                  {stats && (
